...
/**
 * Builds the ChatModel for the worker role.
 */
@Service
@RequiredArgsConstructor
public class WorkerStreamingChatModelBuilder {

    private final DrawAiConfig drawAiConfig;

    public StreamingChatModel build() {
        ChatModelConfig cfg = drawAiConfig.getChatModelConfigByRoleName(RoleNameTypes.WORKER.value());

...
/**
 * Builds the ChatModel for the leader role.
 */
@Service
@RequiredArgsConstructor
public class LeaderStreamingChatModelBuilder {

    private final DrawAiConfig drawAiConfig;

    public StreamingChatModel build() {
        ChatModelConfig cfg = drawAiConfig.getChatModelConfigByRoleName(RoleNameTypes.LEADER.value());
